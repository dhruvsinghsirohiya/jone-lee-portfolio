...
const handleToggle = () => {
  ...
  return ( // Adding the return statement
    ...
    {/* Mobile Device */}
        <ul className={` ${toggle === false ? "hidden" : "flex nav-items"} duration-500 lg:hidden absolute w-full h-[100vh] top-0 left-0 bg-white text-black justify-center flex-col text-[13px] gap-6  items-center uppercase`}>
