  ...
  return ( // Adding the return statement
    <div className="lg:w-[95%] px-2 lg:px-0 relative flex justify-between items-center mx-auto text-white py-4 lg:py-6 ">
        ...
        <ul className={`hidden lg:flex text-[#c4cfde] justify-start text-[13px] gap-8 items-center uppercase`}>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#home">Home</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#features">Features</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#portfolio">Portfolio</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#resume">Resume</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#clients">Clients</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#pricing">Pricing</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#blog">Blog</a></li>
            <li className='lg:hover:text-white cursor-pointer duration-200'><a href="#contact">Contact</a></li>
