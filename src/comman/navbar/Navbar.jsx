...
const Navbar = () => {
  ...
  return (
    ...
    <div className="lg:w-[95%] z-[99] px-2 lg:px-0 relative flex justify-between items-center mx-auto text-white py-4 lg:py-6 ">
      <img src={logo} className="h-[55px] cursor-pointer lg:h-[70px]" alt="" />
      <ul
        className={`hidden lg:flex text-[#c4cfde] justify-start text-[13px] gap-8 items-center uppercase`}
      >
